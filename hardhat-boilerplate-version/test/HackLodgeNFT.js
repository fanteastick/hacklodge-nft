...
// an async function.
describe("HackLodgeNFT contract", function () {
  ...
  describe("Deployment", function () {
    ...
    it("Should set the correct name and symbol", async function () {
      expect(await nft.name()).to.equal("HackLodge");
      expect(await nft.symbol()).to.equal("HL");
    });
  });
